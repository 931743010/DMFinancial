//
//  DMYinhanglicaiDetailViewController.m
//  DMFinancial
//
...
@interface DMYinhanglicaiDetailViewController () <UITableViewDataSource, UITableViewDelegate>

@property (nonatomic, strong) UITableView *tableView;
@property (nonatomic, strong) DMDetailTopView *detailTopView;
@end

@implementation DMYinhanglicaiDetailViewController
