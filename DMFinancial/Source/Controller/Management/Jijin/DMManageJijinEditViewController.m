//
//  DMManageJijinEditViewController.m
//  DMFinancial
//
...
#import "DMManageJijinEditViewController.h"
#import "DMInfoCell.h"
#import "DMManagementService.h"

@interface DMManageJijinEditViewController () <UITableViewDataSource, UITableViewDelegate, DMInfoCellDelegate>

@property (nonatomic, strong) UITableView *tableView;
@end

@implementation DMManageJijinEditViewController
...
-(UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section {
    ...
    label.text = @"添加该基金的持有份数后，会自动跟踪该笔资产的市场净值变化，但是如果有新的购买和赎回时，需要您及时修改";
