...
@end
@implementation DMChatOtherCell
...
- (void)setup
{
    ...
    _avatarImageView.frame = CGRectMake(8, 8+12, 42, 42);
    ...
    UIImage *image = [UIImage imageNamed:@"chat_pinglunkuang_white"];
...
//    self.timeLabel.hidden = hiddenTimeLabel;
    ...
    self.avatarImageView.frame = CGRectMake(14, marginTop, 36, 36);
    self.userNameLabel.text = item.userName;
    [self.userNameLabel sizeToFit];
    self.userNameLabel.frame = CGRectMake(14 + 36 + 7 + 5, marginTop, self.userNameLabel.size.width, self.userNameLabel.size.height);
    self.contentImageView.frame = CGRectMake(14 + 36 + 7, marginTop + self.userNameLabel.size.height + 6, ceil(rect.size.width) + 13 * 2 + 5, ceil(rect.size.height) + 11 *2);
    self.messageLabel.frame = CGRectMake(14 + 36 + 7 + 5 + 13, marginTop + self.userNameLabel.size.height + 6 + 11, ceil(rect.size.width), ceil(rect.size.height));
