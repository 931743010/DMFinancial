...
- (void)separatedByString:(NSString *)separator usingBlock:(void (^)(id obj, NSUInteger idx, BOOL *stop))block {
...
+ (NSString *)getStringWithDate:(NSDate *)date formatterType:(NSString *)formatterType {
