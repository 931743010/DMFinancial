//
//  DMManageYinhangkaEditViewController.m
//  DMFinancial
//
...
#import "DMManageYinhangkaEditViewController.h"
#import "DMInfoCell.h"
#import "DMManagementService.h"

@interface DMManageYinhangkaEditViewController () <UITableViewDataSource, UITableViewDelegate, DMInfoCellDelegate>

@property (nonatomic, strong) UITableView *tableView;
@end

@implementation DMManageYinhangkaEditViewController
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.row == 0) {
        cell.textLabel.text = @"卡内余额";
        cell.detailText = @"0";
    } else {
        cell.textLabel.text = @"银行卡号";
        cell.detailText = @"卡号末4位，选填";
    }
