//
//  DMManageYinhanglicaiEditViewController.m
//  DMFinancial
//
...
#import "DMManageYinhanglicaiEditViewController.h"
#import "DMInfoCell.h"
#import "DMManagementService.h"

@interface DMManageYinhanglicaiEditViewController () <UITableViewDataSource, UITableViewDelegate, DMInfoCellDelegate>

@property (nonatomic, strong) UITableView *tableView;
@end

@implementation DMManageYinhanglicaiEditViewController
...
-(UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section {
    ...
    label.text = @"添加投资金额后，即可跟踪该笔资产到期时间和收益";
